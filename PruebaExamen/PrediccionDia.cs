...
namespace PruebaExamen
{
    public class PrediccionDia : INotifyPropertyChanged
    {
        ...
        public string Dia
        {
            ...
            {
                _dia = value;
                this.NotifyPropertyChanged("dia");
            }
        }
        ...
        public string Prediccion
        {
            ...
            {
                _prediccion = value;
                this.NotifyPropertyChanged("prediccion");
            }
        }
        ...
        public int MinimaFarenheit
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged("minimaFarenheit");
            }
        }
        ...
        public int MaximaFarenheit
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged("maximaFarenheit");
            }
        }
